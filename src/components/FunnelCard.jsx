...
export default function FunnelCard({ text, Icon, to }) {
    ...
    return (
        <Link to={to} className="relative cursor-pointer bg-white  w-6/6 h-6/6 flex flex-col justify-center items-center rounded-2xl shadow-md transition duration-300 hover:bg-gray-100 group">
